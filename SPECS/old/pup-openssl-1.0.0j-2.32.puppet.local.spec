## Build Me Like This:
## PATH=/opt/freeware/bin:$PATH rpm -ba pup-openssl-1.0.0e-1.32.puppet.local.spec

%define _prefix /opt/puppet/pup-openssl
%define openssldir /opt/puppet/pup-openssl
%define openssldir64 /opt/puppet/pup-openssl/64
...
BuildRequires:  make pup-zlib-local
...
export CFLAGS="-DSYSV -D_AIX -D_AIX32 -D_AIX41 -D_AIX43 -D_AIX51 -D_AIX52 -D_AIX53 -D_AIX61 -D_ALL_SOURCE -DFUNCPROTO=15 -O -I/opt/puppet/pup-zlib/include"

export LDFLAGS="-L/opt/puppet/pup-zlib/lib -Wl,-blibpath:/usr/lib:/lib -Wl,-bmaxdata:0x80000000"

#export OBJECT_MODE=64
#export CC="gcc -maix64"
#export AR=/usr/bin/ar
#ARFLAGS="-X64"
#export CPATH="/opt/puppet/pup-zlib/include/"
#
#./Configure \
...
export LDFLAGS="-L/opt/puppet/pup-zlib/lib -Wl,-blibpath:/opt/puppet/pup-zlib/lib:/opt/puppet/pup-openssl/lib:/usr/lib:/lib -Wl,-bmaxdata:0x80000000"
...
%changelog
* Tue Jan 15 2013 by Toni Schmidbauer <toni@stderr.at> 1.0.0j-1.puppet.local
- Updated openssl to 1.0.0j
