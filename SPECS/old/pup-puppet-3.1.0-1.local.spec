...
Source0:        %{tarballname}/%{tarballname}-3.1.0.tar.gz
...
%changelog
* Tue Mar 04 2013 Toni Schmidbauer <toni@stderr.at> - 3.1.0-1.local
- Puppet version 3.1.0
