## Build Me Like This:
## PATH=/opt/freeware/bin:$PATH rpm -ba pup-openssl-1.0.1e-1.32.puppet.local.spec

%define _prefix /opt/puppet
%define openssldir /opt/puppet
%define openssldir64 /opt/puppet
%define _defaultdocdir %{_prefix}/doc
%define libsslver 1.0.1
...
%changelog
* Mon Aug 28 2013 by Toni Schmidbauer <toni@stderr.at> 1.0.1e-1.puppet.local
- update to version 1.0.1e
