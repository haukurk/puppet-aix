%define install_prefix /opt/puppet/pup-puppet
...
Source:		%{tarballname}-%{version}-p352.tar.gz
...
export LDFLAGS="-L/opt/puppet/pup-openssl/lib -Wl,-blibpath:/opt/puppet/pup-openssl/lib:/usr/lib:/lib -Wl,-bmaxdata:0x80000000"
...
./configure --prefix=%{install_prefix} --with-zlib-include=/opt/puppet/pup-zlib/include --with-zlib-lib=/opt/puppet/pup-zlib/lib --with-openssl-dir=/opt/puppet/pup-openssl 
gmake 
